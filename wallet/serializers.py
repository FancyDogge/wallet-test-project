...
class FullWalletSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        raise serializers.ValidationError({'error': 'you can\'t have more than 5 wallets!'})
...
class TransactionSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        def get_commision(transfer_amount, commision_bool):
            return  transfer_amount * decimal.Decimal(0.10) if commision_bool else decimal.Decimal(0.00)
        ...
        if sender_wallet.owner == self.context["request"].user:
            ...
            if receiver_wallet.currency == sender_wallet.currency:
                ...
                commision_bool = False if receiver_wallet.owner == sender_wallet.owner else True
                ...
                with transaction.atomic():
                    ...
                    sender_balance_after_transac = sender_wallet.balance - (new_transaction.transfer_amount + new_transaction.commision)
                    ...
                    if sender_balance_after_transac >= decimal.Decimal(0.00):
                        ...
                        raise serializers.ValidationError({'error': 'not enough money for transaction!'})
                    sender_wallet.save()
